...
{
    info->img_sprites[0].addr = mlx_get_data_addr(info->sprite_north, &info->img_sprites[0].bits_per_pixel, &info->img_sprites[0].line_length, &info->img_sprites[0].endian);
    info->img_sprites[1].addr = mlx_get_data_addr(info->sprite_south, &info->img_sprites[1].bits_per_pixel, &info->img_sprites[1].line_length, &info->img_sprites[1].endian);
    info->img_sprites[2].addr = mlx_get_data_addr(info->sprite_west, &info->img_sprites[2].bits_per_pixel, &info->img_sprites[2].line_length, &info->img_sprites[2].endian);
    info->img_sprites[3].addr = mlx_get_data_addr(info->sprite_east, &info->img_sprites[3].bits_per_pixel, &info->img_sprites[3].line_length, &info->img_sprites[3].endian);
}
